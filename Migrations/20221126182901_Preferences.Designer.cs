...
namespace JEI.Migrations
{
    ...
    [Migration("20221126182901_Preferences")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryUser", b =>
                {
                    b.Property<int>("PreferedCategoriesId")
                        .HasColumnType("int");

                    b.Property<int>("PreferingUsersId")
                        .HasColumnType("int");

                    b.HasKey("PreferedCategoriesId", "PreferingUsersId");
            ...
            modelBuilder.Entity("CategoryUser", b =>
                {
                    b.HasOne("JEI.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("PreferedCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JEI.Models.User", null)
                        .WithMany()
                        .HasForeignKey("PreferingUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
